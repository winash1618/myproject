    ...
    for ka=1:pop
        ...
        for k=1:x
            for i=1:z
                if i~=25
                    ...
                    fis1(ka,k)=fis1(ka,k)+0.249*tim(po1(k,i),po1(k,i+1))*jio(1,k)
                    end
               else
                    break
               end
        ...
        for k=1:x
            ...
            if tempo(ka,k)>0
                ...
                fis1(ka,k)=fis1(ka,k)+0.249*dib(k,po1(k,1))+0.249*dib(k,po1(k,tempo(ka,k)))*jio1(1,k)
