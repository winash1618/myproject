...
bmc=["KEEZHPALLY"  "ODEMTHODE"  "THOLUMBRA" "THILLANKERI" "PAZHASSI RAJA NAGAR" "KEEZHPALLY"  "ODEMTHODE"  "PAZHASSI RAJA NAGAR" 
]
yum=0
for i=1:1:x
    for j=1:z
