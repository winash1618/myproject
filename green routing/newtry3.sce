        ...
        for k=1:x
            for i=1:sizer(1,k)
                ...
                elseif i==sizer(1,k)
                    ...
                    for j=1:z
                        klop(1,j)=b(1,j)*jeep(po(k,i-1),j)
                        klop1(1,j)=b(1,j)*heep(k,j)
                        if klop(1,j)==0
                            klop(1,j)=10000000*100000000000000
                        end
                        if klop1(1,j)==0
                            klop1(1,j)=10000000*100000000000000
                        end
                    end
                    r=0
                    j=1
