...
function [aa,dis] = mutation(po,aa,sizer1,dix)
    dix=dis
    for i=1:x
        nick=po(i,:)
        nick1=sizer1(1,i)
    ...
    for i=1:x
        if sizer1(1,i)==1
            ...
            if prob<0.8
                for j=1:x
                    if sizer1(1,j)>1
                        sizer1(1,i)=sizer1(1,i)-1
                        sizer1(1,j)=sizer1(1,j)+1
                        break
                    end
                end
            end
        ...
        if sizer(1,i)>0
            for j=1:sizer1(1,i)
                ...
                elseif j==sizer1(1,i)
                    ...
                    dist(1,i)=dist(1,i)+tim(po(i,j-1),po(i,j))
                end
            end
        end
    end
...
for y=1:iter
    for i=1:pop
        ...
        [aa,dis] = mutation(po,aa,sizer1,dix)
