    ...
    for j in range(iter):
        ...
        for i in range(ps):
            ...
            if hip<pls:
                ...
                # else:
                #     pl=random.random()
                #     if 0.9*tim[x-1,y-1]<tom[x-1,y-1]:
                #         a[i,:]=pi3
            else:
...
#         hi4[vv]=hi3[0,j]
# =============================================================================
        # pi7=LocalSearch(nss(pib.copy(),x),x,y)
        # gom=setuptime(pi7,x,y)
        # gim=setuptime(a[vv[0],:][:],x,y)
        # prob=random.random()
        # while gom[x-1,y-1]>=gim[x-1,y-1] :
        #     pi7=LocalSearch(nss(pib.copy(),x),x,y)
        #     prob=random.random()
        #     gom=setuptime(pi7,x,y)
        #     print(gom[x-1,y-1],gim[x-1,y-1])
        #     if prob<0.01:
        #         break
        # a[vv,:]=pi7.copy()
    q=q+1
