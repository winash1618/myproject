...
float length[sta]={12,14,12,11,12,13,11};
float tme[sta][n]={{4,8,7,7,8,5,9,6,7},{6,9,4,4,8,7,7,8,5},{8,6,6,6,9,4,4,8,7},{4,7,5,6,9,4,4,8,7},{4,6,9,4,8,5,9,6,7},{6,9,6,5,8,7,7,8,5},{8,6,8,7,9,4,4,8,7}};
...
void fitness_value_pareto(void)
{
	...
	for(i=0;i<2*sn;i++)
	{
		for(j=0;j<2*sn;j++)
		{
            ...
            {
                    //printf("%fghgfghfgf%f",tfit[0],tfit[1]);
                    tfit2[i]+=1;
            }
